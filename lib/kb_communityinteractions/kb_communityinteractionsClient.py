...
class kb_communityinteractions(object):
    ...
    def predict_trophic_interactions(self, params, context=None):
        ...
        return self._client.call_method(
            'kb_communityinteractions.predict_trophic_interactions',
            [params], self._service_ver, context)

    def status(self, context=None):
        return self._client.call_method('kb_communityinteractions.status',
