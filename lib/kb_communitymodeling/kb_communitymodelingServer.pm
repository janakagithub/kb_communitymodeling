package kb_communitymodeling::kb_communitymodelingServer;
...
our %return_counts = (
        'predict_trophic_interactions' => 1,
        'meta_genome_model_construction' => 1,
        'status' => 1,
);

our %method_authentication = (
        'predict_trophic_interactions' => 'required',
        'meta_genome_model_construction' => 'required',
);
...
sub call_method {
    ...
    my $ctx = kb_communitymodeling::kb_communitymodelingServerContext->new($self->{loggers}->{userlog},
...
{
    # Service kb_communitymodeling requires authentication.
	...
	{
	    $self->exception('PerlError', "Authentication required for kb_communitymodeling but no authentication header was passed");
	}
    ...
    my @result;
    {
        ...
        my $stderr = kb_communitymodeling::kb_communitymodelingServerStderrWrapper->new($ctx, $get_time);
        $ctx->stderr($stderr);
...
sub get_method
{
    ...
    {
	$self->exception('NoSuchMethod',
			 "'$method' is not a valid method in service kb_communitymodeling.");
    }
...
package kb_communitymodeling::kb_communitymodelingServerContext;

use strict;

=head1 NAME

kb_communitymodeling::kb_communitymodelingServerContext
...
package kb_communitymodeling::kb_communitymodelingServerStderrWrapper;
...
unless (caller) {
    ...
    my $server = kb_communitymodeling::kb_communitymodelingServer->new(
